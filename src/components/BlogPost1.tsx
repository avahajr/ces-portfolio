...
function BlogPost1({title, subtitle, date, demo}: BlogPostProps) {
    return (<Container style={{marginBottom: "3em"}}>
            <Row>
                <Col md={3}></Col>
                <Col md={6}>
      ...
      `}
                    ...
                    <Row>
                        <Col md={6}>
                            <img
                                ...
                                src={process.env.PUBLIC_URL + "/posts/post1/media/4_IMG_2626.webp"}
                        ...
                        <Col md={6}>
                            <img
                                className="rounded img-fluid"
                                src={process.env.PUBLIC_URL + "/posts/post1/media/11_IMG_2633.webp"}
                    ...
                    <Row>
                        <Col md={12}>
                            ...
                            <img
                                className="rounded img-fluid"
                                src={process.env.PUBLIC_URL + "/posts/post1/media/19_IMG_2642.png"}
